 ...
 *  \return void
 *  \details Функция текстурирования nmglGetTexEnvfv работает в соответствии со следующим алгоритмом:
 ...
 *  \param params указатель на область памяти, в которую необходимо поместить значение считываемого параметра.
 *  \return void
 *  \details Функция текстурирования nmglGetTexEnviv работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details Функция текстурирования nmglGetTexParameteriv работает в соответствии со следующим алгоритмом:
...
Текущая матрица, М, определяет трансформацию координат. Рассмотрим принцип действия М-матрицы моделирования. Если v = v0 v1 v2 v3 это набор координат вершин, и m указывает на массив 16-символьных значений с плавающей запятой, одинарной или двойной точности: m = m0 m1 ... m15 , тогда преобразование иллюстрации модели M x v будет следующим:
 ...
 *  \return void
 *  \details *  \details Функция текстурирования nmglMultiTexCoord2f работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details Функция текстурирования nmglMultiTexCoord2fv работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details *  \details Функция текстурирования nmglTexCoordPointer работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details Функция текстурирования nmglTexEnvfv работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details *  \details Функция текстурирования nmglTexEnvi работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details *  \details Функция текстурирования nmglTexParameteri работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details Функция текстурирования nmglTexImage2D работает в соответствии со следующим алгоритмом:
 ...
 *  \return void
 *  \details Алгоритм работы функции состоит в следующем:
...
/**
 *  \brief Функция nmglColorTableEXT предназначена для задания палитры цветов для текстурного объекта.
 ...
 *  \param data указатель на массив данных текселей загружаемой палитры.
 *  \return void
 *  \details Функция nmglColorTableEXT работает в соответствии со следующим алгоритмом:
