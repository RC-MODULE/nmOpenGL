...
macro macroDepthTest(N)
	...
	rep N [ar6++gr6] = afifo;	
	push ar1,gr1	with gr4 += gr2 noflags;	
	push ar6,gr6	with gr5 += gr2 noflags;
	ar0 = gr4 with gr7--;
...
global _depthTestCore16_Gt_r: label;
global _depthTestCore32_Gt_r: label;
<_depthTestCore16_Gt_r>
<_depthTestCore32_Gt_r>
