#ifndef BOARDMC12101_REMOTE_H
#define BOARDMC12101_REMOTE_H
#include <exception>
#include <cstdio>
#include <iostream>
#include <string>
#include "mc12101load_rpc.h"
...
class BoardMC12101Remote : public BoardMC12101{
private:

    char programNames[MC12101_COUNT_OF_CORES][1024];
    int _boardIndex = -1;
    bool is_opened;
    RPL_Access access[MC12101_COUNT_OF_CORES];
    RPL_Access io_access[MC12101_COUNT_OF_CORES];
