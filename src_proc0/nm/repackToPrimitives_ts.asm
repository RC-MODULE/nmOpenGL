...
global _repackToPrimitives_ts: label;// объявление глобальной метки
...
<_repackToPrimitives_ts>	// определение глобальной метки
    ar5 = ar7 - 2;
