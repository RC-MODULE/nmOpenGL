...
global _repackToPrimitives_tf: label;// объявление глобальной метки
...
<_repackToPrimitives_tf>	// определение глобальной метки
    ar5 = ar7 - 2;
