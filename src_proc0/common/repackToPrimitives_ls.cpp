...
SECTION(".text_demo3d")
int repackToPrimitives_ls(const v4nm32f *srcVertex,	const v4nm32f *srcColor, const v2nm32f *srcTex,	LinePointers *dstPointers, int vertexAmount){
	int result = vertexAmount - 1;
