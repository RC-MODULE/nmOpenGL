...
solution "demo3d-mc12101"
   ...
   project "mc12101-host"
	...
	project "mc12101-nmc4-0"
	  ...
	  includedirs { "$(MC12101)/include","$(HAL)/include","$(NMPP)/include","../../include", "../../utilities/include", "../include"}
	  defines { "__GNUC__"}
	 
	  configuration "Debug"
		   defines { "DEBUG"}
		   buildcommands {"make nm0"}
		   rebuildcommands {"make -B nm0"}
	...
	project "mc12101-nmc4-1"
	  ...
	  includedirs { "$(MC12101)/include","$(HAL)/include","$(NMPP)/include","../../include", "../../utilities/include"}
	  defines { "__GNUC__"}
	 
	  configuration "Debug"
		   defines { "DEBUG"}
		   buildcommands {"make nm1"}
		   rebuildcommands {"make -B nm1"}
		   cleancommands {"make clean"}
