...
solution "demo3d-host-x86"
   ...
   project "demo3d-host-x86"
		kind "ConsoleApp"
		language "C++"
		files { "../../include/*.h","../src_host/*.cpp","../src_host/*.c", "../../nmglvs_x86/src_host/*.cpp"}
...
solution "demo3d-target0-x86"
   ...
   project "demo3d-target0-x86"
      kind "ConsoleApp"
	  language "C++"
      files { "../../include/*.h","../src_target0/*.*", "../../src_proc0/pc/*.*","../../src_proc0/common/*.*","../../src_proc0/nmgl/*.*","../../nmglvs_x86/src_nmc0/*.*", "mc12101brd-nmc0.cfg", "Makefile0" }
...
solution "demo3d-target1-x86"
   ...
   project "demo3d-target1-x86"
      kind "ConsoleApp"
	  language "C++"
      files { "../../include/*.h","../src_target1/*.*", "../../src_proc1/pc/*.*","../../src_proc1/common/*.*", "../../nmglvs_x86/src_nmc1/*.*","mc12101brd-nmc1.cfg", "Makefile1" }
	  libdirs { "$(NMPP)/lib","$(HAL)/lib"}
	  includedirs { "$(MC12101)/include","$(HAL)/include","$(NMPP)/include","../../include"}
	  links { "nmpp-x86.lib","hal-virtual-x86.lib"}
