...
solution "demo3d-target0-x86"
   ...
   project "demo3d-target0-x86"
      kind "ConsoleApp"
	  language "C++"
      files { "../../include/*.h","../src_target0/*.cpp", "../../src_proc0/pc/*.*","../../src_proc0/common/*.*","../../src_proc0/nmgl/*.*","../../nmglvs_mc12101-gcc/src_nmc0/*.*", "Makefile0" }
...
solution "demo3d-target1-x86"
   ...
   project "demo3d-target1-x86"
      kind "ConsoleApp"
	  language "C++"
      files { "../../include/*.h","../src_target1/*.cpp", "../../src_proc1/pc/*.*","../../src_proc1/common/*.*", "../../nmglvs_mc12101-gcc/src_nmc1/*.*", "Makefile1" }
