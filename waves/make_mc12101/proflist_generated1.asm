...
NONCFUNC(ConvU32toD,      "ConvU32toD      ");// 0x0000000027000dbe [.text]
FUNCTION(__open,          "__open          ");// 0x0000000027000dd6 [.text]
FUNCTION(__close,         "__close         ");// 0x0000000027000e20 [.text]
FUNCTION(__read,          "__read          ");// 0x0000000027000e36 [.text]
FUNCTION(__write,         "__write         ");// 0x0000000027000e62 [.text]
FUNCTION(__kill,          "__kill          ");// 0x0000000027000ede [.text]
FUNCTION(__getpid,        "__getpid        ");// 0x0000000027000ee8 [.text]
FUNCTION(__lseek,         "__lseek         ");// 0x0000000027000ef2 [.text]
FUNCTION(__stat,          "__stat          ");// 0x0000000027000f30 [.text]
FUNCTION(__fstat,         "__fstat         ");// 0x0000000027001034 [.text]
FUNCTION(__isatty,        "__isatty        ");// 0x00000000270010d4 [.text]
FUNCTION(__link,          "__link          ");// 0x00000000270010de [.text]
FUNCTION(__unlink,        "__unlink        ");// 0x00000000270010e8 [.text]
FUNCTION(_printf,         "_printf         ");// 0x000000002700135a [.text_printf]
