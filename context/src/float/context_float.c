...
__attribute__((section(".data_imu1"))) static float mem_imu0[12 * POOL_SIZE];
__attribute__((section(".data_imu2"))) static float mem_imu1[12 * POOL_SIZE];
__attribute__((section(".data_imu3"))) static float mem_imu2[12 * POOL_SIZE];
__attribute__((section(".data_imu4"))) static float mem_imu3[12 * POOL_SIZE];
__attribute__((section(".data_imu5"))) static float mem_imu4[12 * POOL_SIZE];
...
//void context_float_init(void){
    ...
    context.poolsCount = 6;
    context.poolSize32 = 12 * POOL_SIZE;
}
