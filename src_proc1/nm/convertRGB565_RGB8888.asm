...
data ".data_demo3d"        // секция инициализированных данных
    ...
    rgbMatrix: long[32] =  (
                           ...
                           00000000000000000hl,
                           00000000000000000hl,
                           00000000000000000hl,     // rrggrrgg00000000 -> 00rrgg0000rrgg00
                           00000000000000000hl,
                           00000000000000000hl,
                           00000000000000000hl,
                           00000000000000000hl,
                           ...
                           00000010000000000hl,
                           00001000000000000hl,
                           00000000000000000hl,     // 00bb00bb00000000 -> 000000bb000000bb
                           00000000000000000hl,
                           00000000000000000hl,
                           00000000000000000hl,
                           00000000000000001hl,
...
<Convert>
    ...
    ar1 = rMatrix;  
    sir = 088808880h; // разбиение матрицы весовых коэффициентов
    nb1 = sir; // разбиение матрицы весовых коэффициентов
    sir = 020022000h;
    sbl = sir;
    sir = 022022202h;
    sbh = sir;
    ...
    ar1 = gMatrix;
    sir = 0a28aa28ah;   // разбиение матрицы весовых коэффициентов
    nb1 = sir;   // разбиение матрицы весовых коэффициентов
    sir = 08a2a8a2ah;
    sb = sir;
    ...
    ar1 = bMatrix;
    sir = 088208820h;   // разбиение матрицы весовых коэффициентов
    nb1 = sir;   // разбиение матрицы весовых коэффициентов
    sir = 020822082h;
    sb = sir;
    ...
    ar1 = rgbMatrix;
    sir = 080808080h;   // разбиение матрицы на 8 столбцов по 8 бит
    nb1 = sir;   // разбиение матрицы на 8 столбцов по 8 бит
    sir  = 002020202h;   // разбиение матрицы на 8 строк по 8 бит
    sb  = sir;   // разбиение матрицы на 8 строк по 8 бит
