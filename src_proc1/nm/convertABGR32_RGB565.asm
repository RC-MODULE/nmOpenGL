...
data ".data_demo3d"        // секция инициализированных данных
    ...
    // Маска для входа X
    rgMsk: long = 0fC000000f8000000hl;
    ...
    rgMatrix: long[8] = (
                        00000000000000000hl,    // shift r and g
                        00000000000000001hl,
                        00000000000000000hl,
                        00000000000000040hl,
                        00000000000000000hl,    // shift b
                        00000000000001000hl,
                        00000000000000000hl,
                        00000000000000000hl
                        );
...
<ConvertOneValue>
    ...
    nb1l = 020820h; // разбиение матрицы весовых коэффициентов
    nb1h = 00h;
    sb = 08000002h;
    ...
    ftw, wtw;
    rep 1 data = [ar3++gr3] with vsum ram, shift data, afifo;
